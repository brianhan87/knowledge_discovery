...
var check_list = [];
var dt = new Date();
var tdt = dt.getFullYear()+'-'+leadingZeros(dt.getMonth()+1,2)+'-'+leadingZeros(dt.getDate(),2);
    ...
    if($.cookie('data_check')) {
        ...
        $('.add_rule').on('click', function() {
            if(client_id != '' && conclusion_id != '') {
                var rds_add_url = 'http://219.252.39.18:8080/rdr-web/index.htm?clientId=' + client_id + '&conclusionId=' + conclusion_id + '&kaMode=add';
        ...
        $('.edit_rule').on('click', function() {
            if(client_id != '' && conclusion_id != '') {
                var rds_edit_url = 'http://219.252.39.18:8080/rdr-web/index.htm?clientId=' + client_id + '&conclusionId=' + conclusion_id + '&kaMode=edit';
        ...
        $('.delete_rule').on('click', function() {
            if(client_id != '' && conclusion_id != '') {
                var rds_delete_url = 'http://219.252.39.18:8080/rdr-web/index.htm?clientId=' + client_id + '&conclusionId=' + conclusion_id + '&kaMode=delete';
     ...
     $('.final').on('click', function() {
          ...
          $.ajax({
              ...
              success : function(data) {
                       ...
                       var hhh = data.agg_con.conclusions;
                       for(var i = 0; i < hhh.length; i++) {
                            var conclusion_rule_ids = hhh[i];
                          $('.modal .description').val($('.modal .description').val() +conclusion_rule_ids+'\n');
                          }
...
/*
    $('.final').on('click', function() {
        $('.modal textarea').val('');
        var patient_name = $('.modal .name_data').val();
        var final_conclusion_html_title = patient_name + '님의 검진 결과는 다음과 같sss습니다.\n\n';
