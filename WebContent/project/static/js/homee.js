...
$(function() {
    ...
    $('.patient_info tr .date').each(function() {
        ...
        $('.delete_rule').on('click', function() {
            if(client_id != '' && conclusion_id != '') {
                var rds_delete_url = '219.252.39.18:8080/rdr-web/index.htm?clientId=' + client_id + '&conclusionId=' + conclusion_id + '&kaMode=delete';
            ...
            if($(this).hasClass('active')) {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        record_date = data.patient_data.recorded_date;
