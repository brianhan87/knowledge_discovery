...
public class Search_servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String queries = request.getParameter("allQuery");
		...
		try {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/annotation.jsp?pageNum="+pageNum);	
		...
		if(queries.isEmpty())
		{
			RequestDispatcher dispatcher = request.getRequestDispatcher("/annotation.jsp");	
			dispatcher.forward(request, response);
			
		}
		else
		{
			ArrayList<EBook> results = new ArrayList<EBook>();
			Search s = new Search();
			try {
				results = s.search(queries);
